...
export const AUTO_PUSH_MIN_SCORE = 40; // combined score threshold for auto Notion push
...
export async function captureLead({
  ...
  // Note: Notion push is now triggered after email verification (see api/verify-email.js)
  // The lead is stored in Supabase immediately, but only pushed to Notion once verified.
...
// ─────────────────────────────────────────────────────────────────────────────
// Notion write — exported for use by verify-email.js
// ─────────────────────────────────────────────────────────────────────────────
export async function pushToNotion(lead) {
